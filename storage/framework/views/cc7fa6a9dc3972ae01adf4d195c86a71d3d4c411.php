...
<!-- Modal content -->
<div class="modal " id="edit-<?php echo e($historico->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="<?php echo e(route('auth.editar_historico',$historico->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
   ...
   <?php /**PATH C:\Users\bfggd\history-checkout\resources\views/auth/edit.blade.php ENDPATH**/ ?>